...
separate_columns <- function(data, list_column_name, num_columns) {
  ...
  result_datm$avg_result <- rowMeans(select(result_data, starts_with(list_column_name)))
...
write.csv(mHB_Top_Three, file = "men_mHB_Top_Three.csv")
...
write.csv(mFX_Top_Three, file = "men_mFX_Top_Three.csv")
...
write.csv(mPB_Top_Three, file = "men_mPB_Top_Three.csv")
...
write.csv(mPH_Top_Three, file = "men_mPH_Top_Three.csv")
...
write.csv(mSR_Top_Three, file = "men_mSR_Top_Three.csv")


mVT_separated_data <- separate_columns(mFX, "SimulationResults", 1000)
...
write.csv(mVT_Top_Three, file = "men_mVT_Top_Three.csv")
...
write.csv(mHB_prepared, file = "men_mHB_Weighted_Medals.csv")
write.csv(mPB_prepared, file = "men_mPB_Weighted_Medals.csv")
write.csv(mPH_prepared, file = "men_mPH_Weighted_Medals.csv")
write.csv(mFX_prepared, file = "men_mFX_Weighted_Medals.csv")
write.csv(mSR_prepared, file = "men_mSR_Weighted_Medals.csv")
write.csv(mVT_prepared, file = "men_mVT_Weighted_Medals.csv")
```
