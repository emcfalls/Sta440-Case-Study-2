...
*checking to see that there is at least 5 people per country (only 4 for Korea for uneven bars)* 
```{r}
...
### 3. Function for Candidates (top 5 for each apparatus by Country)
