...
get_team_scores <- function(iter, hb, fx, pb, ph, sr, vt){
  ...
  top_candidates <- candidates(iter, all_eligible, hb, fx, pb, ph, sr, vt)
...
```{r}
# once you break up the dfs by apparatus, just run thi
all_team_scores <- get_team_scores(1000, hb, fx, pb, ph, sr, vt)
```
